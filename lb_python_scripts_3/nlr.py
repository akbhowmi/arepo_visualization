...
def add_hbeta_sources(dir, sfrhistfile, snapnum):
    ...
    hdu.data.field('L_lambda')[nold-nbh:nold+nadd-nbh] = log10(hbetased+1.0e+32)
    #hdu.data.field('L_lambda')[nold-nbh:nold+nadd-nbh] = log10(hbetased+1.0e+31)
    ...
    # TEMPORARY; DEBUG ONLY:
    ised_new = ised+ised_hbeta+1e+32
    #ised_new = ised+ised_hbeta+1e+31
    #ised_new = ised+ised_hbeta+1e+30
